...
#define STRING_CONFIG_H_AUTHOR "Hobi, Alfawise Ux0" // Who made the changes.
 ...
 */
#define SPI_SPEED SPI_HALF_SPEED // Just a safe measure to be sure SDcards are working. could be removed
